...
sns.heatmap(df, cmap="viridis", annot=True, cbar=True, fmt='.3f', annot_kws={'fontsize': 15}, cbar_kws=dict(pad=-0.06, shrink=0.79))
...
plt.savefig("./img/SAC_Eff_corr1.jpg", dpi=600)
# plt.clf()
# plt.close()
plt.show()

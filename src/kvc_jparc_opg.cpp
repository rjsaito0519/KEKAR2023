...
Int_t main(int argc, char** argv) {
    ...
    // | pro version |
    // +-------------+
    std::vector<Int_t> ana_run_num{ 23, 24, 26, 28, 30, 31, 35, 36, 45, 47, 48, 51, 52, 55, 57, 60, 61 };

    // +--------------------------+
    // | prepare output root file |
    // +--------------------------+
    TString output_path = OUTPUT_DIR + "/root/kvc_jparc_opg.root";
    ...
    TString pdf_name = OUTPUT_DIR + "/img/kvc_jparc_opg.pdf";
